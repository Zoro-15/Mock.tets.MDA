    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-surface-custom border border-[#334155] rounded-2xl shadow-2xl overflow-hidden z-10 p-6 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            onClick={onCancel}
            className="w-full py-2.5 bg-[#334155] hover:bg-[#334155]/80 text-text-secondary-custom rounded-xl text-sm font-semibold transition-colors cursor-pointer outline-none"
          >
            No, Resume
          </button>
          <button
            onClick={onConfirm}
            className="w-full py-2.5 bg-primary-custom hover:bg-primary-custom/90 text-white rounded-xl text-sm font-semibold transition-colors cursor-pointer outline-none"
          >
            Yes, Submit
          </button>
        </div>
