    ...
    <div className="min-h-screen bg-[#0F172A] text-[#F8FAFC]">
      ...
      <header className="border-b border-[#334155]/60 bg-[#1E293B]/80 sticky top-0 z-30 backdrop-blur-md">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div>
            <h1 className="font-extrabold text-lg text-[#F8FAFC]">Previous Year Papers</h1>
            <p className="text-[10px] text-[#CBD5E1]/60 font-bold uppercase tracking-wider">NDA Official Papers (2015-2025)</p>
          </div>
        </div>
      </header>
