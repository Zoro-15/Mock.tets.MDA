          ...
          <div className="bg-surface-custom border border-[#334155]/40 rounded-xl overflow-hidden shadow-sm">
            {leaderboard.length > 0 ? (
              ...
              <div className="p-8 flex flex-col items-center justify-center text-center space-y-3">
                <div className="w-12 h-12 bg-[#334155]/20 rounded-full flex items-center justify-center text-text-secondary-custom">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                  </svg>
                </div>
                <h4 className="text-sm font-semibold text-text-primary-custom">No tests qualify for the leaderboard yet</h4>
                <p className="text-xs text-text-secondary-custom">Complete a test that takes more than 90 minutes to claim your spot!</p>
              </div>
            )}
          </div>
        </section>
